...
(page-merge-stk) waited for child 0
(page-merge-stk) waited for child 1
(page-merge-stk) waited for child 2
(page-merge-stk) waited for child 3
(page-merge-stk) waited for child 4
(page-merge-stk) waited for child 5
(page-merge-stk) waited for child 6
(page-merge-stk) waited for child 7
